...
SubsidyLookPersonManage.initColumn = function () {
    return [
        ...
        {title: '住房补贴金额', field: 'rent', align: 'center', valign: 'middle', sortable: true},
        {title: '住房补贴开始时间', field: 'startTime', align: 'center', valign: 'middle', sortable: true},
        {title: '住房补贴结束时间', field: 'endTime', align: 'center', valign: 'middle', sortable: true},
        {title: '操作人姓名', field: 'oprationName', align: 'center', valign: 'middle', sortable: true},
        {title: '解除人姓名', field: 'relieveOprationName', align: 'center', valign: 'middle', sortable: true},
        {title: '解除时间', field: 'relieveTime', align: 'center', valign: 'middle', sortable: true},
